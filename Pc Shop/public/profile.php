            ...
            <div class="row">
                <div class="col-md-3 col-sm-4">
                    ...
                    <ul class="list-group mt-3">
                      <li class="list-group-item active"><a href="profile.php" class="text-white">Osobni podaci</a></li>
                ...
                <div class="col-md-9 col-sm-8">
                    <h4 class="mt-3 text-primary center">Osobni podaci</h4>
                    <div class="row mt-3">
                        <div class="col-md-4">
                            <div class="data shadow p-3 mb-5 bg-white rounded">
                                <h5 class="text-secondary">Ime:</h5>
                                <?php echo $prijavljeni_korisnik["firstName"]?>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="data shadow p-3 mb-5 bg-white rounded">
                                <h5 class="text-secondary">Prezime:</h5>
                                <?php echo $prijavljeni_korisnik["surName"]?>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="data shadow p-3 mb-5 bg-white rounded">
                                <h5 class="text-secondary">Adresa:</h5>
                                <?php echo $prijavljeni_korisnik["address"]?>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="data shadow p-3 mb-5 bg-white rounded">
                                <h5 class="text-secondary">Telefon:</h5>
                                <?php echo $prijavljeni_korisnik["phone"]?>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="data shadow p-3 mb-5 bg-white rounded">
                                <h5 class="text-secondary">Email:</h5>
                                <?php echo $prijavljeni_korisnik["email"]?>
                            </div>
                        </div>
